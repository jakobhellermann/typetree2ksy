...
- id: m_assetbundlevariant
  type: string
- id: m_generatebackface
  type: b1
- id: m_mergecoplanarfaces
  type: b1
- id: align4
  if: (_io.pos % 4) != 0
  size: (4 - (_io.pos % 4) % 4)
...
- id: align4
  if: (_io.pos % 4) != 0
  size: (4 - (_io.pos % 4) % 4)
- id: m_sketchupimportdata
  type: sketchupimportdata
types:
  string:
    seq:
    - id: size
